const PRODUCTS = {
  "NORA KOLTUK": {
    ...
    shortDesc: "Modern çizgileriyle yaşam alanınıza zarafet katan koltuk takımı, konfor ve şıklığı bir araya getiriyor.",
    longDesc: "Bu koltuk takımı, çağdaş tasarımıyla evinizin atmosferine estetik bir dokunuş yaparken, yüksek oturma konforu sayesinde uzun süreli keyifli zamanlar sunar.Kaliteli kumaş dokusu, dayanıklı iskelet yapısı ve detaylardaki özenli işçilikle hem tarz hem de dayanıklılık arayanlar için ideal bir seçenektir.Geniş oturma alanı ve yumuşak minderleriyle misafirlerinizi ağırlarken rahatlığı hissedersiniz. İster klasik ister modern dekorasyona sahip olun, bu koltuk takımı yaşam alanınıza kusursuz bir uyum sağlar.",          
    types: "Koltuk Takımı",
    materials: "Fırınlanmış gürgen iskelet, Leke tutmaz ve kolay temizlenebilir dokuma kumaş",
  ...
  "ARTEMİS KOLTUK": {
    ...
    shortDesc: "Şıklığı ve konforu buluşturan koltuk takımı, yaşam alanınıza zarif bir dokunuş katıyor.",
    longDesc: "Bu koltuk takımı, modern çizgileriyle estetiği ve rahatlığı mükemmel bir dengede sunar. Geniş oturma alanı, yumuşak minder yapısı ve ergonomik sırt desteği sayesinde günün yorgunluğunu keyifle atmanızı sağlar. Yüksek kaliteli kumaş dokusu, leke tutmayan yapısı ve dayanıklı iskelet sistemiyle uzun yıllar boyunca ilk günkü formunu korur. Farklı renk ve kumaş alternatifleriyle her tarza uyum sağlayan bu takım, hem misafirlerinizi ağırlarken hem de günlük kullanımlarda konforlu bir deneyim yaşatır. Evinizin atmosferini tamamlayan zarif detaylarıyla, salon dekorasyonunuzun odak noktası olur.",
    types: "Koltuk Takımı",
  ...
  "ALORA KOLTUK": {
    ...
    shortDesc: "Sade ve zarif hatlarla günlük konforu bir araya getirir.",
    longDesc: "Zamana meydan okuyan tasarımıyla dikkat çeken bu koltuk takımı, estetik görünümünü işlevsellikle birleştirir. Geniş oturum alanı ve yumuşak dokulu kumaşı sayesinde maksimum konfor sunarken, dayanıklı iskelet yapısı uzun ömürlü kullanım garantisi verir. Modern ve klasik çizgileri harmanlayan tasarımı, her yaşam alanına uyum sağlayarak sıcak bir atmosfer oluşturur. İnce dikiş detayları, zarif ayak tasarımı ve özenle seçilmiş renk tonlarıyla evinizdeki dekorasyonu bir üst seviyeye taşır. Günlük kullanımda rahatlık, özel anlarda ise şıklık arayanlar için mükemmel bir tercihtir.",
    types: "Sofa, Oturma Grubu",
    materials: "Ahşap iskelet, kumaş döşeme",
    features: "3+3+1 düzen, yumuşak sünger, nefes alan kumaş"
  },
  ...
  "SIENA KOSE": {
    ...
    types: "Köşe Takımı",
    materials: "Metal veya masif ahşap, zemin dostu tasarım",
